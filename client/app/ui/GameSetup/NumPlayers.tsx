    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        >
          ...
          <span className="text-xs text-white/50 leading-relaxed px-2">Head-to-head duel. Simple, competitive, fast</span>
        </motion.button>
        ...
        >
          ...
          <span className="text-xs text-white/50 leading-relaxed px-2">Four-player team battle. Cooperate for the win</span>
        </motion.button>
      </div>
      <div className="pt-4">
