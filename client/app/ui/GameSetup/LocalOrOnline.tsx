  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <motion.button
          whileHover={{ scale: 1.03, borderColor: "rgba(0, 245, 212, 0.6)", backgroundColor: "rgba(255, 255, 255, 0.04)" }}
          whileTap={{ scale: 0.98 }}
        ...
        >
          <div className="w-14 h-14 rounded-2xl bg-white/4 flex items-center justify-center mb-4 group-hover:bg-[rgba(0,245,212,0.1)] transition-colors border border-white/5">
            <svg className="w-7 h-7 text-white opacity-80 group-hover:text-accent-1 group-hover:opacity-100 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
            </svg>
          </div>
          <span className="font-bold text-lg text-white mb-1.5">Local Multiplayer</span>
          <span className="text-xs text-white/50 leading-relaxed px-2">Pass and play with friends on a single device</span>
        </motion.button>
        ...
        >
          ...
          <span className="text-xs text-white/50 leading-relaxed px-2">Create or join rooms to play online across devices</span>
        </motion.button>
      </div>
      <div className="pt-4">
