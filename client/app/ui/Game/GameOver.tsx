...
export default function GameOver({ winner, totalScores, resetGame, roundHistory, onBackToMenu }: ChildProps) {
  return (
    <div
      className="absolute inset-0 mx-auto my-auto w-[330px] h-[450px] md:w-[500px] md:h-[700px] p-5 bg-slate-600 opacity-95 text-white rounded-lg border-2 border-solid bg-game-panel
