...
export default function Crib({ crib, dealer, players, turn, playerId, lobbyId, numPlayers, discardToCrib }: CribProps) {
  ...
  // Card height scales with viewport height.
  // Width is automatically calculated from the image's aspect ratio.
  const cardImgClasses =
    "h-[6.05vh] md:h-[7.15vh] lg:h-[7.15vh] xl:h-[8.45vh] 2xl:h-[10.4vh] w-auto rounded-md shadow-lg object-contain";

  return (
    <div className="w-fit lg:w-full bg-game-panel p-2 md:p-4 rounded-lg shadow-lg">
